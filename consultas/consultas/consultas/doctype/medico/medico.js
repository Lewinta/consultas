...
frappe.ui.form.on('Medico', {
	...
	especialidad:function(frm){
		frappe.model.set_value(frm.doctype,frm.docname,"especialidad",(frm.doc.especialidad).toUpperCase());
	},
	centro:function(frm){
		frappe.model.set_value(frm.doctype,frm.docname,"centro",(frm.doc.centro).toUpperCase());
	}
});
